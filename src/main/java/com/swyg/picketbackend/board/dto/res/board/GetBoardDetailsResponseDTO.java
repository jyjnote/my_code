...
//    private  List<Board> recommendedPosts; // 추천 게시물 목록
    ...
    // entity -> dto
    public static GetBoardDetailsResponseDTO toDTOList(Board board,List<SimpleBoardDTO> recommendedPosts) {
        ...
        return GetBoardDetailsResponseDTO.builder()
                ...
                .recommendedPosts(recommendedPosts) // 추천 게시물 목록 설정
                .build();
    }
